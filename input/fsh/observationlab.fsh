Profile: MIPHRObservationLaboratory
Parent: Observation
Id: miphr-observation-laboratory
Title: "MIPHRObservationLaboratory"
* identifier 1..1
* identifier
  * system 1..
  * value 1..
...
* code.coding
  * system 1..
  * system = "https://hira.or.kr/CodeSystem/lab-result-code" (exactly)
  * code 1..
* subject 1..
* subject
  * reference 1..
